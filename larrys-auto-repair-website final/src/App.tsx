...
const featuredServices: ServiceItem[] = [
  {
    ...
    image: "https://images.pexels.com/photos/8478233/pexels-photo-8478233.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "glass",
    title: "Auto Glass",
    text: "Chip repair and windshield replacement.",
    image: "https://images.pexels.com/photos/8478224/pexels-photo-8478224.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "oil",
    title: "Oil & Maintenance",
    text: "Keep it running strong.",
    image: "https://images.pexels.com/photos/4895412/pexels-photo-4895412.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "scan",
    title: "Check Engine Light",
    text: "We find the problem fast.",
    image: "https://images.pexels.com/photos/4116172/pexels-photo-4116172.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
];
...
const repairServices: ServiceItem[] = [
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/8986130/pexels-photo-8986130.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "oil",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/8478247/pexels-photo-8478247.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "battery",
    title: "Batteries & Electrical",
    text: "Testing, replacement and electrical troubleshooting.",
    image: "https://images.pexels.com/photos/4116207/pexels-photo-4116207.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "tire",
    title: "Tires & Suspension",
    text: "Tire service plus suspension and steering repairs.",
    image: "https://images.pexels.com/photos/4116170/pexels-photo-4116170.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
  {
    icon: "clipboard",
    title: "Pre-Trip Inspections",
    text: "Peace of mind before that long road trip.",
    image: "https://images.pexels.com/photos/8986132/pexels-photo-8986132.jpeg?auto=compress&cs=tinysrgb&fit=crop&w=360&h=210",
  },
];
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    window.setTimeout(() => {
      try {
        ...
        setStatus("success");
        setMessage("Got it! We'll call you back shortly.");
        form.reset();
      } catch {
        setStatus("error");
  ...
  return (
    <form className="quote-card" onSubmit={submit}>
      ...
      <label>
        ...
        <label>
          <span>Phone</span>
          <input name="phone" type="tel" autoComplete="tel" placeholder="2085550123" required pattern="[0-9]{10}" minLength={10} maxLength={10} />
        </label>
      <label>
      ...
      {message && (
        <div className={`quote-status ${status}`} role="status">
          {message}
        </div>
      )}
    </form>
  ...
  return (
    <div className={`svc-grid ${columns}`}>
      {items.map((service, index) => (
        <article className={`svc-card ${service.image ? "detail" : ""}`} key={service.title} style={{ animationDelay: `${index * 70}ms` }}>
    ...
    <main className="route-page home-page">
      ...
      <section className="review">
        <div className="shell review-inner">
          ...
          <blockquote>"Very quick turnaround, and does a great job!"</blockquote>
  ...
  return (
    <main className="route-page">
      ...
      <section className="map-section" aria-label="Map to Larry's Auto Repair and Glass">
        <iframe title="Map to Larry's Auto Repair & Glass" src={MAPS_EMBED} loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
      </section>
    </main>
  );
}
  ...
  return (
    <>
      <footer>
        ...
        <div className="shell foot-bottom">Copyright {new Date().getFullYear()} Larry's Auto Repair &amp; Glass | Preston, Idaho</div>
      </footer>
